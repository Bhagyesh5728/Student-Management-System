...
<div class="col-sm-8"><h2>Teacher <b>Details</b></h2></div>
 ...
 <div class="col-sm-4">
                 <a href="addTeacher.jsp"> <button type="button" class="btn btn-info add-new"><i class="fa fa-plus"></i> Add New Teacher</button></a>
                    </div>
</div>
</div>
...
try
{
	...
	ResultSet rs=sc.executeQuery("select name,email,mobile,address,photo from member where role='teacher'");
	while(rs.next())
	{
...
<a href="../delete?id=<%=rs.getLong("mobile") %>&name=teacher"  class="delete" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>
</td>
</tr>
<%} 
