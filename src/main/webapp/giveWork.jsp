...
<div class="card-body">
<form action="./workt" method="post" enctype="multipart/form-data">
<div class="row">
<div class="col-12">
...
<input class="form-control" type="text"  name="sname" placeholder="Enter Subject Name" required>
</div>
</div>
...
<select name="cource" style="width: 220px; font-size:15px;  height:  40px; background: white; border-radius: 5px; border-color: gray; " onchange="showHint(this.value)">
<option>BCA</option>
<option>BSCIT</option>
</select>
</div>
...
<select name="sem" style="width: 220px; font-size:15px;  height:  40px; background: white; border-radius: 5px; border-color: gray; " onchange="showHint(this.value)">
<option>1</option>
<option>2</option>
<option>3</option>
<option>4</option>
...
<select name="class" style="width: 220px; font-size:15px;  height:  40px; background: white; border-radius: 5px; border-color: gray; " onchange="showHint(this.value)">
<option>A</option>
<option>B</option>
<option>C</option>
</select>
